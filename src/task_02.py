...
def task_2(frames, time_line, sample_frekvency):
    # choose correct frame from signal
    my_frame = frames[7]
    show_frames_graph(frames, my_frame, time_line, sample_frekvency)
    return my_frame


def show_frames_graph(frames, my_frame, time_line, sample_frekvency):
